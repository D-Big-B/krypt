...
export default function Welcome() {
  ...
  return (
    <div className="flex w-full justify-center items-center">
      <div className="flex mf:flex-row w-10/12 flex-col item-start justify-between md:py-12 px-4">
        <div className="flex flex-1  justify-start flex-col mf:mr-10">
          <h1 className="text-3xl sm:text-5xl text-white text-gradient py-1">
            Send Crypto <br /> across the world
          </h1>
          <p className="text-left mt-5 font-light text-white md:w-9/12 w-11/12 text-base">
            Explore the cryto world. Buy and sell the cryptocurrencies easily on
            Krypto.
          </p>
          {!currentAccount && (
            <button
        ...
        <div className="flex flex-col items-center justify-start flex-1 w-full mf:mt-0 mt-10">
